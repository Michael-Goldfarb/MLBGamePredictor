...
cursor.execute("""
    CREATE TABLE IF NOT EXISTS pt2previousYearHittingStats2022 (
        player_id TEXT,
        gameId TEXT,
        player_name TEXT,
        obp TEXT,
...
cursor.execute("TRUNCATE TABLE pt2previousYearHittingStats2022;")
...
for index, playerId in enumerate(lineup):
    ...
    cursor.execute("""
        INSERT INTO pt2previousYearHittingStats2022 (
